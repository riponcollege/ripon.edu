    ...
    $meta_boxes['infographic_metabox'] = array(
        ...
        'fields' => array(
            array(
                ...
                'name' => 'Background Image/Photo',
                'description' => 'Select a square-shaped, blurry image so that it can be used on all screen sizes as a background for the infographic. If no image is selected, the light red background color will be used.',
                'type' => 'file',
            ...
            array(
                ...
                'type' => 'group',
                'description' => __('Add buttons to this section.', 'cmb'),
                'options' => array(
